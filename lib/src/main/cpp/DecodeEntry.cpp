...
extern "C" jstring Java_com_ray_lib_codescan_Decoder_decodeFromJNI(JNIEnv *env, jobject thiz,
                                                                     jint decodeCode,
                                                                     jbyteArray data,
                                                                     jint dataWidth,
                                                                     jint dataHeight,
...
extern "C" jstring Java_com_ray_lib_codescan_Decoder_decodeFileFromJNI(JNIEnv *env, jobject thiz,
                                                                         jint decodeCode,
                                                                         jintArray pixels,
